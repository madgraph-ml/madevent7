...
public:
    ...
    void
    combine_to_lhe_npy(const std::string& file_name, const LHECompleter& lhe_completer);
    void
    combine_to_lhe(const std::string& file_name, const LHECompleter& lhe_completer);
