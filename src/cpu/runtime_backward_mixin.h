...
case 5:
    ...
    break;
case 9:
    backward_batch_foreach<tensor_foreach<backward_kernel_product<CpuTypes>, backward_kernel_product<SimdTypes>, 2, 1, 1>, 1, 1, 1, 0>(instr, locals, local_grads, {0}, {}, device);
    break;
case 55:
