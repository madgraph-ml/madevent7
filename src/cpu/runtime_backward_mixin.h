...
case 66:
    ...
    break;
case 67:
    backward_batch_foreach<tensor_foreach<backward_kernel_rqs_activation<CpuTypes>, backward_kernel_rqs_activation<SimdTypes>, 5, 2, 1, DeviceType>, 2, 3, 0, 2>(instr, locals, local_grads, {}, {0,1}, device);
    break;
case 68:
...
case 70:
    ...
    break;
case 71:
    backward_batch_foreach<tensor_foreach<backward_kernel_softmax<CpuTypes>, backward_kernel_softmax<SimdTypes>, 2, 1, 1, DeviceType>, 1, 1, 0, 1>(instr, locals, local_grads, {}, {0}, device);
    break;
case 72:
