...
case 8:
    ...
    break;
case 9:
    batch_foreach<tensor_foreach<kernel_product<CpuTypes>, kernel_product<SimdTypes>, 1, 1, 1>, 1, 1>(instr, locals, device);
    break;
case 10:
    batch_foreach<tensor_foreach<kernel_clip_min<CpuTypes>, kernel_clip_min<SimdTypes>, 2, 1, 1>, 2, 1>(instr, locals, device);
    break;
case 11:
...
case 12:
    ...
    break;
case 13:
    batch_foreach<tensor_foreach<kernel_pow<CpuTypes>, kernel_pow<SimdTypes>, 2, 1, 1>, 2, 1>(instr, locals, device);
    break;
case 14:
    batch_foreach<tensor_foreach<kernel_uniform_phi<CpuTypes>, kernel_uniform_phi<SimdTypes>, 1, 1, 1>, 1, 1>(instr, locals, device);
    break;
case 15:
    batch_foreach<tensor_foreach<kernel_uniform_phi_inverse<CpuTypes>, kernel_uniform_phi_inverse<SimdTypes>, 1, 1, 1>, 1, 1>(instr, locals, device);
    break;
case 16:
    batch_foreach<tensor_foreach<kernel_uniform_costheta<CpuTypes>, kernel_uniform_costheta<SimdTypes>, 1, 1, 1>, 1, 1>(instr, locals, device);
    break;
case 17:
    batch_foreach<tensor_foreach<kernel_uniform_costheta_inverse<CpuTypes>, kernel_uniform_costheta_inverse<SimdTypes>, 1, 1, 1>, 1, 1>(instr, locals, device);
    break;
case 18:
    batch_foreach<tensor_foreach<kernel_boost<CpuTypes>, kernel_boost<SimdTypes>, 2, 1, 1>, 2, 1>(instr, locals, device);
    break;
case 19:
    batch_foreach<tensor_foreach<kernel_boost_inverse<CpuTypes>, kernel_boost_inverse<SimdTypes>, 2, 1, 1>, 2, 1>(instr, locals, device);
    break;
case 20:
...
case 21:
    ...
    break;
case 22:
    batch_foreach<tensor_foreach<kernel_com_momentum<CpuTypes>, kernel_com_momentum<SimdTypes>, 1, 1, 1>, 1, 1>(instr, locals, device);
    break;
case 23:
...
case 39:
    ...
    break;
case 40:
    batch_foreach<tensor_foreach<kernel_fast_rambo_r_to_u<CpuTypes>, kernel_fast_rambo_r_to_u<SimdTypes>, 1, 2, 1>, 1, 2>(instr, locals, device);
    break;
case 41:
    batch_foreach<tensor_foreach<kernel_rambo_four_vectors_massless<CpuTypes>, kernel_rambo_four_vectors_massless<SimdTypes>, 4, 2, 1>, 4, 2>(instr, locals, device);
    break;
case 42:
    batch_foreach<tensor_foreach<kernel_rambo_four_vectors_massive<CpuTypes>, kernel_rambo_four_vectors_massive<SimdTypes>, 5, 4, 1>, 5, 4>(instr, locals, device);
    break;
case 43:
...
case 53:
    ...
    break;
case 54:
    batch_foreach<tensor_foreach<kernel_leaky_relu<CpuTypes>, kernel_leaky_relu<SimdTypes>, 1, 1, 2>, 1, 1>(instr, locals, device);
    break;
case 55:
