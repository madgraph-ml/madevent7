...
case 22:
    ...
    break;
case 23:
    batch_foreach<tensor_foreach<kernel_two_particle_decay_com<CpuTypes>, kernel_two_particle_decay_com<SimdTypes>, 5, 3, 1, DeviceType>, 5, 3>(instr, locals, device);
    break;
case 24:
    batch_foreach<tensor_foreach<kernel_two_particle_decay<CpuTypes>, kernel_two_particle_decay<SimdTypes>, 6, 3, 1, DeviceType>, 6, 3>(instr, locals, device);
    break;
case 25:
    batch_foreach<tensor_foreach<kernel_two_particle_scattering_com<CpuTypes>, kernel_two_particle_scattering_com<SimdTypes>, 6, 3, 1, DeviceType>, 6, 3>(instr, locals, device);
    break;
case 26:
    batch_foreach<tensor_foreach<kernel_two_particle_scattering<CpuTypes>, kernel_two_particle_scattering<SimdTypes>, 6, 3, 1, DeviceType>, 6, 3>(instr, locals, device);
    break;
case 27:
