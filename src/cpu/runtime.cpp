...
void op_matrix_element(
    ...
    for (std::size_t i = 0; i < input_count; ++i) {
        ...
        contiguous_inputs[i] = locals[instruction.input_indices[3 + 2 * i + 1]]
            .contiguous(batch_size, device);
    ...
    device.foreach(
        batch_size,
        [
            contiguous_inputs, input_count, input_keys, input_ptrs,
            output_count, output_keys, output_ptrs, &matrix_element, batch_size
