...
case 10:
    ...
    break;
case 11:
    batch_foreach<kernel_pow, 2, 1, false>(instr, locals);
    break;
case 12:
...
case 45:
    ...
    break;
case 46:
    batch_foreach<kernel_fast_rambo_r_to_u, 1, 2, false>(instr, locals);
    break;
case 47:
    batch_foreach<kernel_rambo_four_vectors_massless, 4, 2, false>(instr, locals);
    break;
case 48:
    batch_foreach<kernel_rambo_four_vectors_massive, 5, 4, false>(instr, locals);
    break;
