...
InstructionPtr instructions[] {
    ...
    mi("decay_momentum", 26, {scalar, scalar, scalar, scalar}, {four_vector, scalar}),
    ...
    mi("two_particle_density_inverse", 30, {scalar, scalar, scalar}, {scalar}),
    mi("tinv_two_particle_density", 31, {scalar, scalar, scalar, scalar}, {scalar}),
    mi("tinv_two_particle_density_inverse", 32, {scalar, scalar, scalar, scalar}, {scalar}),
    mi("uniform_invariant", 33, {scalar, scalar, scalar}, {scalar, scalar}),
    mi("uniform_invariant_inverse", 34, {scalar, scalar, scalar}, {scalar, scalar}),
    mi("breit_wigner_invariant", 35, {scalar, scalar, scalar, scalar, scalar}, {scalar, scalar}),
    mi("breit_wigner_invariant_inverse", 36, {scalar, scalar, scalar, scalar, scalar}, {scalar, scalar}),
    mi("stable_invariant", 37, {scalar, scalar, scalar, scalar}, {scalar, scalar}),
    mi("stable_invariant_inverse", 38, {scalar, scalar, scalar, scalar}, {scalar, scalar}),
    mi("stable_invariant_nu", 39, {scalar, scalar, scalar, scalar, scalar}, {scalar, scalar}),
    mi("stable_invariant_nu_inverse", 40, {scalar, scalar, scalar, scalar, scalar}, {scalar, scalar}),
};
