...
InstructionOwner instructions[] {
    ...
    mi("cut_pt", 48, {four_vector_array, limit_array}, {scalar}),
    mi("cut_eta", 49, {four_vector_array, limit_array}, {scalar}),
    mi("cut_dr", 50, {four_vector_array, index_array_2, limit_array_m}, {scalar}),
    mi("cut_m_inv", 51, {four_vector_array, index_array_k, limit_array_m}, {scalar}),
    mi("cut_sqrt_s", 52, {four_vector_array, limits}, {scalar}),
