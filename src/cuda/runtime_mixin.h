...
case 12:
    ...
    break;
case 13:
    batch_foreach<tensor_foreach_dynamic<kernel_add_int<CudaTypes>, 2, 1>, 2, 1>(instr, locals, device);
    break;
case 14:
...
case 26:
    ...
    break;
case 27:
    batch_foreach<tensor_foreach<kernel_two_body_decay_com<CudaTypes>, 5, 3, 1>, 5, 3>(instr, locals, device);
    break;
case 28:
    batch_foreach<tensor_foreach<kernel_two_body_decay<CudaTypes>, 6, 3, 1>, 6, 3>(instr, locals, device);
    break;
case 29:
    batch_foreach<tensor_foreach<kernel_two_to_two_particle_scattering_com<CudaTypes>, 6, 3, 1>, 6, 3>(instr, locals, device);
    break;
case 30:
    batch_foreach<tensor_foreach<kernel_two_to_two_particle_scattering<CudaTypes>, 6, 3, 1>, 6, 3>(instr, locals, device);
    break;
case 31:
    batch_foreach<tensor_foreach<kernel_two_to_three_particle_scattering<CudaTypes>, 8, 3, 1>, 8, 3>(instr, locals, device);
    break;
case 32:
    batch_foreach<tensor_foreach<kernel_three_body_decay_com<CudaTypes>, 9, 4, 1>, 9, 4>(instr, locals, device);
    break;
case 33:
    batch_foreach<tensor_foreach<kernel_three_body_decay<CudaTypes>, 10, 4, 1>, 10, 4>(instr, locals, device);
    break;
case 34:
    batch_foreach<tensor_foreach<kernel_t_inv_min_max<CudaTypes>, 4, 2, 1>, 4, 2>(instr, locals, device);
    break;
case 35:
    batch_foreach<tensor_foreach<kernel_s_inv_min_max<CudaTypes>, 6, 2, 1>, 6, 2>(instr, locals, device);
    break;
case 36:
